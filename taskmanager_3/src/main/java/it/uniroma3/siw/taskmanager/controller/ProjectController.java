...
public class ProjectController {
	...
	@RequestMapping(value = {"/projects/{projectId}/deleteTask/{taskId}"}, method = RequestMethod.GET)
	...
	public String updateTask(@ModelAttribute("task") Task newTask, Model model,  
